...
Object.keys(themes).forEach(themeName => {
  ...
  btn.onclick = () => applyTheme(themes[themeName]);
  themeOptions.appendChild(btn);
});

// Append to chat container
chatContainerEl.parentNode.insertBefore(themeContainer, chatContainerEl.nextSibling);
chatContainerEl.parentNode.insertBefore(themeOptions, chatContainerEl.nextSibling);
